...
export default function SearchListBoard2({value, index, setsearchData, props, category}) {
    // console.log(value)
    const { schoolSearch,
         setSchoolSearch,
         sectorSearch, 
  ...
  const [api, setApi] = useState([]);
    ...
    return (<ListItem onClick={()=>{}}>나의 직업은?
    {sectorSearch2.map((item, index)=>(<SelectItems key={index }
    onClick={()=>{sectorSearch2.splice(index,1); sectorSearch.splice(index,1)}}
